...
const SignIn = () => {
    ...
    return (
        <div className="login-bg text-dark">
            <div className="login-page d-flex justify-content-center align-items-center align-items-lg-start">
                <div className="container p-4 p-lg-0 login-content">
                    <div className="row g-5">
                        <div className="col-12 col-lg-6">
                            <div className="login-content-bg">
                                <div className="d-flex justify-content-between mb-5">
                                    <NavLink to="/login" className="text-decoration-none text-dark text-center py-2 w-100" activeStyle={{ backgroundColor: "rgb(207, 206, 199)" }}>Sign In</NavLink>
                                ...
                                <form onSubmit={handleCustomLogin} className="px-3">
                                    ...
                                    <div className="text-center">
                                        <button type="submit" className="btn btn-outline-dark rounded-0 mb-3">SignIn</button>
                                        <p>New User? <NavLink className="text-decoration-none text-dark account-switch ms-2" to="/signup">Create Account</NavLink></p>
                                    </div>
                                </form>
                                <hr className="mt-4" />
                                <div className="text-center">
